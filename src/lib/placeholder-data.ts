...
export const placeholderProducts: Product[] = [
  ...
  {
    id: 'p6',
    name: 'אבקת כביסה "כביסכל אקו-פאוור"',
    description: 'אבקת כביסה אקולוגית, יעילה גם בטמפרטורות נמוכות.',
    price: 45.90,
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'eco powder',
    category: 'אבקות כביסה',
    isActive: true,
  },
  {
    id: 'p7',
    name: 'ג\'ל כביסה "כביסכל בייבי סופט"',
    description: 'ג\'ל כביסה עדין במיוחד לבגדי תינוקות ובעלי עור רגיש.',
    price: 52.90,
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'baby gel',
    category: 'ג\'לים לכביסה',
  ...
  {
    id: 'p8',
    name: 'מרכך כביסה מרוכז "לבנדר חלומי"',
    description: 'מרכך בניחוח לבנדר מרגיע, מותיר את הכביסה רכה ונעימה.',
    price: 31.90,
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'lavender softener',
    category: 'מרככי כביסה',
    isActive: true,
  },
  {
    id: 'p9',
    name: 'דפי כביסה בניחוח אוקיינוס',
    description: 'דפי כביסה חדשניים המונעים הצטברות אבנית ומעניקים רעננות.',
    price: 28.50,
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'laundry sheets',
    category: 'תוספי כביסה',
    isActive: true,
  },
  {
    id: 'p10',
    name: 'מלבין כביסה "אוקסי אקטיב"',
    description: 'מלבין עוצמתי על בסיס חמצן פעיל, לכביסה לבנה וצחורה.',
    price: 26.90,
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'bleach powder',
    category: 'מסירי כתמים',
    isActive: true,
  },
  {
    id: 'p11',
    name: 'מבשם אריגים "פריחת הכותנה"',
    description: 'תרסיס מבשם לארונות ובגדים, בניחוח כותנה נקי ורענן.',
    price: 22.00,
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'fabric freshener',
    category: 'מבשמי כביסה',
    isActive: true,
  },
  {
    id: 'p12',
    name: 'כדורי מייבש צמר טבעי (3 יח\')',
    description: 'כדורי צמר טבעי לריכוך הכביסה במייבש וקיצור זמן הייבוש.',
    price: 35.00,
    imageUrl: 'https://placehold.co/600x400.png',
    dataAiHint: 'wool balls',
    category: 'אביזרים',
    isActive: true,
  }
];

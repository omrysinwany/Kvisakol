...
export const placeholderProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'מבשם אריגים לביגוד וארונות בניחוח קיץ מרענן.',
    price: 25.00,
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    category: 'נוזלי כביסה', // קטגוריה נפרדת ממוצרי Bio
    isActive: true,
  },
  {
    id: 'kcat8',
...
export const placeholderOrders: Order[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { productId: 'kbio11', productName: 'כביסכל Bio רד רוז – 2 ליטר', quantity: 1, priceAtOrder: 43.00 },
    ],
    totalAmount: 45.00 + 43.00,
